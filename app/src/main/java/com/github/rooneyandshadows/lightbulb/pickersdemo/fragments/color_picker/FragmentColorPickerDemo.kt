...
class FragmentColorPickerDemo :
    ...
    @Override
    override fun initializeViewModel(viewModel: VMColorPickerDemo, savedInstanceState: Bundle?) {
    ...
    @Override
    override fun doOnViewBound(viewBinding: FragmentColorPickerDemoBinding, savedInstanceState: Bundle?) {
