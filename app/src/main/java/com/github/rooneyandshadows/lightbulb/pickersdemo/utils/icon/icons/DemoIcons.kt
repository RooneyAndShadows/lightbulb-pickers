...
@Suppress("unused")
enum class DemoIcons(val iconName: String, override val icon: IIcon) : IDemoIcon {
    ...
    companion object {
        fun valueOf(iconName: String): DemoIcons {
            return values().filter { return@filter it.iconName == iconName }[0]
        }
