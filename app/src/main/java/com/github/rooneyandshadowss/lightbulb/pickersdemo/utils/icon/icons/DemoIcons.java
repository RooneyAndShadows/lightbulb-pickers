package com.github.rooneyandshadowss.lightbulb.pickersdemo.utils.icon.icons;

import com.github.rooneyandshadowss.lightbulb.pickersdemo.utils.icon.IDemoIcon;
...
public enum DemoIcons implements IDemoIcon {
    ...
    private static final Map<String, DemoIcons> values = new HashMap<>();

    DemoIcons(String value, IIcon icon) {
        this.name = value;
        this.icon = icon;
    }
