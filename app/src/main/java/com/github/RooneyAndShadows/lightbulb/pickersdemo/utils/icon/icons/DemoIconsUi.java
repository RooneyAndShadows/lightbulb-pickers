...
public enum DemoIconsUi implements IDemoIcon {
    ...
    ICON_ADAPTER_PICKER_INDICATOR(6, FontAwesome.Icon.faw_shapes),
    ICON_MONTH_PICKER_INDICATOR(7, FontAwesome.Icon.faw_calendar_check1),
    ICON_DATE_PICKER_INDICATOR(8, FontAwesome.Icon.faw_calendar_day);
